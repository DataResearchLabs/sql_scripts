...
-- T038 ------------------------------------------------------------------------------------------
-- "RS-6 Text" #18 - Verify OnlyAllowedChars() where [phone_number] only has characters ".012345678" in table [employees]
...
-- T040 ------------------------------------------------------------------------------------------
-- "RS-6 Text" #20 - Verify IsNumeric() where [zip9] will convert to numeric in table [employees]
